...
/// \param responseHandler 回调
///
- (void)getVideoPlaybackListWithDeviceId:(NSString * _Nonnull)deviceId timezone:(NSInteger)timezone dateTime:(NSString * _Nonnull)dateTime responseHandler:(void (^ _Nullable)(NSString * _Nullable, NSError * _Nullable))responseHandler;
/// 倍速回放
/// \param deviceId 设备id
///
...
/// 全时套餐
  IVVASServiceTypeVss = 0,
/// 分时套餐
  IVVASServiceTypeEvs = 1,
};
