...
#define kIoTVideoVersion "1.2(1246)"
...
FOUNDATION_EXPORT IVOptionKey const IVOptionKeyAppVersion;    /**< 使用SDK的APP的版本号 */
FOUNDATION_EXPORT IVOptionKey const IVOptionKeyAppPkgName;    /**< 使用SDK的APP的包名 */
FOUNDATION_EXPORT IVOptionKey const IVOptionKeyAppLanguage;   /**< 使用SDK的APP的语言 */
FOUNDATION_EXPORT IVOptionKey const IVOptionKeyAppID;         /**< 使用SDK的APP_ID */
FOUNDATION_EXPORT IVOptionKey const IVOptionKeyAppToken;      /**< 使用SDK的APP_Token */
FOUNDATION_EXPORT IVOptionKey const IVOptionKeyAppDevType;    /**< 使用SDK的设备类型 保留 */
...
typedef NS_ENUM(NSUInteger, IVLinkStatus) {
    ...
    IVLinkStatusKickOff         = 6, //!< 账号被踢飞, 在别处登陆
};
