...
/// \param response 结果回调
///
- (void)requestWithMethodType:(NSString * _Nonnull)methodType urlString:(NSString * _Nullable)urlString params:(NSDictionary<NSString *, NSObject *> * _Nullable)params response:(void (^ _Nullable)(NSString * _Nullable, NSError * _Nullable))response;
@end
